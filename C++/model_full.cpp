...
void update(vector<double>& time_spike, vector<int>& num_spike, vector<double>& record_time_point, vector<int>& total_HEE, vector<int>& total_HIE, vector<int>& total_HEI,
    vector<int>& total_HII, vector<int>& V_e_distribution, vector<int>& V_i_distribution, Vector<double>& Clock, vector<int>& VE, vector<int>& VI, Vector<int>& HEE, Vector<int>& HEI,
